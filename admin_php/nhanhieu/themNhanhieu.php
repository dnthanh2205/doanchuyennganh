 		...
 		<!-- nội dung phần main-->
        	<div id = "about-us">
				<div class="row about-title">
					<h2 class="regular white">THÊM NHÃN HIỆU NƯỚC HOA</h2>
			  	</div>
			  ...
			  <div class="row about-list-post">
				  ...
				  ?>
						...
						<p><select name="idMenu" id="idMenu" title="chọn">
                            ...
                            { 
                            ?>
                            <option value="<?php echo $r["idMenu"] ?>"><?php echo $r["TenMenu"] ; ?></option>
                                <?php
					...
					<div class="row about-list-post">
                    	...
                    	<div class="col-xs-12 col-sm-12 col-md-4 about-post ">
					  	<input placeholder="Tên nhãn hiệu" type="text"  name="tenNhanhieu" >
                    	</div>
                    </div>
                    ...
                    <?php
						if (isset($_POST["buttonThem"])) {
							...
							$sql = "INSERT INTO nhanhieu  VALUES(NULL,'$tenNhanhieu','$tenLoai') ";
