<?php
	function ChiTietTheLoai($idMenu){
		$qr = "SELECT * FROM menu
			WHERE idMenu='$idMenu'";
			$o = mysqli_connect("localhost", "root", "","nuochoahanghieu");
			mysqli_query($o, "set names 'utf8'");
			$row = mysqli_query($o, $qr);
		
		return mysqli_fetch_array($row);
	}
	
	function ChiTietNuocHoa($idNuochoa){
	...
	function ChiTietNhanHieu($idNhanhieu){
