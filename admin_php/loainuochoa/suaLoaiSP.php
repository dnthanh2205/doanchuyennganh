...
$idMenu = $_GET["idLoai"]; 
settype($idMenu, "int");
$row_loai = ChiTietTheLoai($idMenu);
?>

<?php
if (isset($_POST["buttonSua"]))
{
	$tenLoai = $_POST["suaLoai"];
 		...
 		<!-- nội dung phần main-->
        	<div id = "about-us">
				<div class="row about-title">
					<h2 class="regular white">Sửa Loại Nước Hoa</h2>
				</div>
			  ...
			  <div class="row about-list-post">
					...
					<div class="col-xs-12 col-sm-12 col-md-4 about-post editText">
					  <input value="<?php echo $row_loai["TenMenu"] ?>" type="text"  name="suaLoai">
                    </div>
					<div class="col-xs-12 col-sm-12 col-md-4 about-post button">
					  <input type="submit" name="buttonSua" id="btnThem" value="Sửa">
